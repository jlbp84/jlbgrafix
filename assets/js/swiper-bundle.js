                        ...
                        if ((i.isScrolling && a.emit("touchMoveOpposite", o), void 0 === i.startMoving && ((n.currentX === n.startX && n.currentY === n.startY) || (i.startMoving = !0)), i.isScrolling)) i.isTouched = !1;
                            ...
                            if (
                                ...
                                f > 0 && i.currentTranslate > a.minTranslate()
                                    ...
                                    : f < 0 && i.currentTranslate < a.maxTranslate() && ((g = !1), s.resistance && (i.currentTranslate = a.maxTranslate() + 1 - Math.pow(a.maxTranslate() - i.startTranslate - f, y))),
        ...
        if (((a.isTouched = !1), (a.isMoved = !1), (a.startMoving = !1), (p = i.followFinger ? (r ? t.translate : -t.translate) : -a.currentTranslate), !i.cssMode))
            if (i.freeMode) {
                ...
                if (i.freeModeMomentum) {
                    ...
                    if (w < t.maxTranslate())
                        i.freeModeMomentumBounce ? (w + t.maxTranslate() < -S && (w = t.maxTranslate() - S), (b = t.maxTranslate()), (C = !0), (a.allowMomentumBounce = !0)) : (w = t.maxTranslate()), i.loop && i.centeredSlides && (T = !0);
                    else if (w > t.minTranslate())
                        i.freeModeMomentumBounce ? (w - t.minTranslate() > S && (w = t.minTranslate() + S), (b = t.minTranslate()), (C = !0), (a.allowMomentumBounce = !0)) : (w = t.minTranslate()), i.loop && i.centeredSlides && (T = !0);
            ...
            update: {
                ...
                updateSlides: function () {
                    ...
                    if (void 0 !== s) {
                                ...
                                p[$] && (p[$].swiperSlideSize = M),
                                    ...
                                    a.centeredSlides
                                        ? ((E = E + M / 2 + x / 2 + b),
                                          ...
                                          h.push(E))
                                        : (a.roundLengths && (E = Math.floor(E)), (T - Math.min(e.params.slidesPerGroupSkip, T)) % e.params.slidesPerGroup == 0 && c.push(E), h.push(E), (E = E + M + b)),
                                    (e.virtualSize += M + b),
                                    (x = M),
                                    (T += 1);
                            }
                        ...
                        if (
                            (0 === c.length && (c = [0]),
                            0 !== a.spaceBetween && (e.isHorizontal() ? (r ? p.filter(f).css({ marginLeft: b + "px" }) : p.filter(f).css({ marginRight: b + "px" })) : p.filter(f).css({ marginBottom: b + "px" })),
            ...
            slide: {
                slideTo: function (e, t, a, i) {
                    ...
                    if (((m = n > u ? "next" : n < u ? "prev" : "reset"), (c && -g === r.translate) || (!c && g === r.translate)))
                        return r.updateActiveIndex(n), l.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), "slide" !== l.effect && r.setTranslate(g), "reset" !== m && (r.transitionStart(a, m), r.transitionEnd(a, m)), !1;
                    if (l.cssMode) {
                        var x,
                            T = r.isHorizontal(),
                            C = -g;
        ...
        ee = {
            ...
            in: function (e) {
                var t,
                    ...
                    T = b.image;
                (x.$slideEl ||
                    (y.params.virtual && y.params.virtual.enabled && y.virtual ? (x.$slideEl = y.$wrapperEl.children("." + y.params.slideActiveClass)) : (x.$slideEl = y.slides.eq(y.activeIndex)),
